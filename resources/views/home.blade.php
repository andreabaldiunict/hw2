...
<body>
    ...
    <section>
        ...
        <div class="slide" id="s1">
            <div class="container">
                <div class="box">
                    ...
                    <a class="view" href='{{url("store")}}'>Store</a>
                </div>
                <div class="box">
        ...
        <div class="slide" id="s3">
            <div class="container">
                <div class="box">
                    <img src='{{url("images/slide_3.svg")}}'>
                </div>
                <div class="box">
            ...
            <div class="box_right">
                ...
                <form class="apy_quotable">
                    <div class="quotable_container">
                        <img src='{{url("images/virgolette_sin.png")}}' class="img_apy_quotable">
                        <div id="container_1"></div>
                        <img src='{{url("images/virgolette_des.png")}}' class="img_apy_quotable">
                    </div>
                </form>
            </div>
        </div>
